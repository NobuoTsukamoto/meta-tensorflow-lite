...
do_install:append() {
    ...
    install -d ${D}${includedir}/tensorflow/lite/micro
    install -d ${D}${includedir}/tensorflow/lite/micro/benchmarks
    install -d ${D}${includedir}/tensorflow/lite/micro/benchmarks
    install -d ${D}${includedir}/tensorflow/lite/micro/cortex_m_generic
    install -d ${D}${includedir}/tensorflow/lite/micro/examples/hello_world
    install -d ${D}${includedir}/tensorflow/lite/micro/examples/hello_world
    install -d ${D}${includedir}/tensorflow/lite/micro/examples/hello_world/disco_f746ng
    install -d ${D}${includedir}/tensorflow/lite/micro/examples/hello_world/riscv32_mcu
    install -d ${D}${includedir}/tensorflow/lite/micro/examples/hello_world/spresense
    install -d ${D}${includedir}/tensorflow/lite/micro/examples/hello_world/zephyr_riscv
    install -d ${D}${includedir}/tensorflow/lite/micro/examples/magic_wand
    install -d ${D}${includedir}/tensorflow/lite/micro/examples/magic_wand
    install -d ${D}${includedir}/tensorflow/lite/micro/examples/magic_wand/arduino
    install -d ${D}${includedir}/tensorflow/lite/micro/examples/magic_wand/riscv32_mcu
    install -d ${D}${includedir}/tensorflow/lite/micro/examples/magic_wand/zephyr_riscv
    install -d ${D}${includedir}/tensorflow/lite/micro/examples/magic_wand/zephyr_riscv/src
    install -d ${D}${includedir}/tensorflow/lite/micro/examples/micro_speech
    install -d ${D}${includedir}/tensorflow/lite/micro/examples/micro_speech
    install -d ${D}${includedir}/tensorflow/lite/micro/examples/micro_speech/CMSIS
    install -d ${D}${includedir}/tensorflow/lite/micro/examples/micro_speech/CMSIS
    install -d ${D}${includedir}/tensorflow/lite/micro/examples/micro_speech/apollo3
    install -d ${D}${includedir}/tensorflow/lite/micro/examples/micro_speech/arc_emsdp
    install -d ${D}${includedir}/tensorflow/lite/micro/examples/micro_speech/arduino
    install -d ${D}${includedir}/tensorflow/lite/micro/examples/micro_speech/disco_f746ng
    install -d ${D}${includedir}/tensorflow/lite/micro/examples/micro_speech/esp
    install -d ${D}${includedir}/tensorflow/lite/micro/examples/micro_speech/esp
    install -d ${D}${includedir}/tensorflow/lite/micro/examples/micro_speech/micro_features
    install -d ${D}${includedir}/tensorflow/lite/micro/examples/micro_speech/osx
    install -d ${D}${includedir}/tensorflow/lite/micro/examples/micro_speech/riscv32_mcu
    install -d ${D}${includedir}/tensorflow/lite/micro/examples/micro_speech/simple_features
    install -d ${D}${includedir}/tensorflow/lite/micro/examples/micro_speech/spresense
    install -d ${D}${includedir}/tensorflow/lite/micro/examples/person_detection
    install -d ${D}${includedir}/tensorflow/lite/micro/examples/person_detection
    install -d ${D}${includedir}/tensorflow/lite/micro/examples/person_detection/arc_emsdp
    install -d ${D}${includedir}/tensorflow/lite/micro/examples/person_detection/arduino
    install -d ${D}${includedir}/tensorflow/lite/micro/examples/person_detection/arduino
    install -d ${D}${includedir}/tensorflow/lite/micro/examples/person_detection/esp
    install -d ${D}${includedir}/tensorflow/lite/micro/examples/person_detection/esp
    install -d ${D}${includedir}/tensorflow/lite/micro/examples/person_detection/himax_driver
    install -d ${D}${includedir}/tensorflow/lite/micro/examples/person_detection/himax_driver
    install -d ${D}${includedir}/tensorflow/lite/micro/examples/person_detection/riscv32_mcu
    install -d ${D}${includedir}/tensorflow/lite/micro/examples/person_detection/spresense
    install -d ${D}${includedir}/tensorflow/lite/micro/kernels
    install -d ${D}${includedir}/tensorflow/lite/micro/kernels/arc_mli
    install -d ${D}${includedir}/tensorflow/lite/micro/kernels/ceva
    install -d ${D}${includedir}/tensorflow/lite/micro/kernels/xtensa
    install -d ${D}${includedir}/tensorflow/lite/micro/memory_planner
    install -d ${D}${includedir}/tensorflow/lite/micro/tools/make
    install -d ${D}${includedir}/tensorflow/lite/micro/tools/make/ext_libs
    install -d ${D}${includedir}/tensorflow/lite/micro/tools/make/targets
    install -d ${D}${includedir}/tensorflow/lite/micro/tools/make/targets/arc
    install -d ${D}${includedir}/tensorflow/lite/micro/tools/make/templates
    ...
    install -d ${D}${includedir}/tensorflow/lite/tools/make/targets
    ...
    install -d ${D}${includedir}/tensorflow/lite/tools/optimize/sparsity
    ...
    install -m 644 ${S}/tensorflow/lite/micro/*.h ${D}${includedir}/tensorflow/lite/micro
    install -m 644 ${S}/tensorflow/lite/micro/benchmarks/*.h ${D}${includedir}/tensorflow/lite/micro/benchmarks
    install -m 644 ${S}/tensorflow/lite/micro/benchmarks/*.inc ${D}${includedir}/tensorflow/lite/micro/benchmarks
    install -m 644 ${S}/tensorflow/lite/micro/cortex_m_generic/*.h ${D}${includedir}/tensorflow/lite/micro/cortex_m_generic
    install -m 644 ${S}/tensorflow/lite/micro/examples/hello_world/*.h ${D}${includedir}/tensorflow/lite/micro/examples/hello_world
    install -m 644 ${S}/tensorflow/lite/micro/examples/hello_world/*.inc ${D}${includedir}/tensorflow/lite/micro/examples/hello_world
    install -m 644 ${S}/tensorflow/lite/micro/examples/hello_world/disco_f746ng/*.inc ${D}${includedir}/tensorflow/lite/micro/examples/hello_world/disco_f746ng
    install -m 644 ${S}/tensorflow/lite/micro/examples/hello_world/riscv32_mcu/*.inc ${D}${includedir}/tensorflow/lite/micro/examples/hello_world/riscv32_mcu
    install -m 644 ${S}/tensorflow/lite/micro/examples/hello_world/spresense/*.inc ${D}${includedir}/tensorflow/lite/micro/examples/hello_world/spresense
    install -m 644 ${S}/tensorflow/lite/micro/examples/hello_world/zephyr_riscv/*.inc ${D}${includedir}/tensorflow/lite/micro/examples/hello_world/zephyr_riscv
    install -m 644 ${S}/tensorflow/lite/micro/examples/magic_wand/*.h ${D}${includedir}/tensorflow/lite/micro/examples/magic_wand
    install -m 644 ${S}/tensorflow/lite/micro/examples/magic_wand/*.inc ${D}${includedir}/tensorflow/lite/micro/examples/magic_wand
    install -m 644 ${S}/tensorflow/lite/micro/examples/magic_wand/arduino/*.inc ${D}${includedir}/tensorflow/lite/micro/examples/magic_wand/arduino
    install -m 644 ${S}/tensorflow/lite/micro/examples/magic_wand/riscv32_mcu/*.inc ${D}${includedir}/tensorflow/lite/micro/examples/magic_wand/riscv32_mcu
    install -m 644 ${S}/tensorflow/lite/micro/examples/magic_wand/zephyr_riscv/*.inc ${D}${includedir}/tensorflow/lite/micro/examples/magic_wand/zephyr_riscv
    install -m 644 ${S}/tensorflow/lite/micro/examples/magic_wand/zephyr_riscv/src/*.h ${D}${includedir}/tensorflow/lite/micro/examples/magic_wand/zephyr_riscv/src
    install -m 644 ${S}/tensorflow/lite/micro/examples/micro_speech/*.h ${D}${includedir}/tensorflow/lite/micro/examples/micro_speech
    install -m 644 ${S}/tensorflow/lite/micro/examples/micro_speech/*.inc ${D}${includedir}/tensorflow/lite/micro/examples/micro_speech
    install -m 644 ${S}/tensorflow/lite/micro/examples/micro_speech/CMSIS/*.h ${D}${includedir}/tensorflow/lite/micro/examples/micro_speech/CMSIS
    install -m 644 ${S}/tensorflow/lite/micro/examples/micro_speech/CMSIS/*.inc ${D}${includedir}/tensorflow/lite/micro/examples/micro_speech/CMSIS
    install -m 644 ${S}/tensorflow/lite/micro/examples/micro_speech/apollo3/*.inc ${D}${includedir}/tensorflow/lite/micro/examples/micro_speech/apollo3
    install -m 644 ${S}/tensorflow/lite/micro/examples/micro_speech/arc_emsdp/*.inc ${D}${includedir}/tensorflow/lite/micro/examples/micro_speech/arc_emsdp
    install -m 644 ${S}/tensorflow/lite/micro/examples/micro_speech/arduino/*.inc ${D}${includedir}/tensorflow/lite/micro/examples/micro_speech/arduino
    install -m 644 ${S}/tensorflow/lite/micro/examples/micro_speech/disco_f746ng/*.inc ${D}${includedir}/tensorflow/lite/micro/examples/micro_speech/disco_f746ng
    install -m 644 ${S}/tensorflow/lite/micro/examples/micro_speech/esp/*.h ${D}${includedir}/tensorflow/lite/micro/examples/micro_speech/esp
    install -m 644 ${S}/tensorflow/lite/micro/examples/micro_speech/esp/*.inc ${D}${includedir}/tensorflow/lite/micro/examples/micro_speech/esp
    install -m 644 ${S}/tensorflow/lite/micro/examples/micro_speech/micro_features/*.h ${D}${includedir}/tensorflow/lite/micro/examples/micro_speech/micro_features
    install -m 644 ${S}/tensorflow/lite/micro/examples/micro_speech/osx/*.inc ${D}${includedir}/tensorflow/lite/micro/examples/micro_speech/osx
    install -m 644 ${S}/tensorflow/lite/micro/examples/micro_speech/riscv32_mcu/*.inc ${D}${includedir}/tensorflow/lite/micro/examples/micro_speech/riscv32_mcu
    install -m 644 ${S}/tensorflow/lite/micro/examples/micro_speech/simple_features/*.h ${D}${includedir}/tensorflow/lite/micro/examples/micro_speech/simple_features
    install -m 644 ${S}/tensorflow/lite/micro/examples/micro_speech/spresense/*.inc ${D}${includedir}/tensorflow/lite/micro/examples/micro_speech/spresense
    install -m 644 ${S}/tensorflow/lite/micro/examples/person_detection/*.h ${D}${includedir}/tensorflow/lite/micro/examples/person_detection
    install -m 644 ${S}/tensorflow/lite/micro/examples/person_detection/*.inc ${D}${includedir}/tensorflow/lite/micro/examples/person_detection
    install -m 644 ${S}/tensorflow/lite/micro/examples/person_detection/arc_emsdp/*.inc ${D}${includedir}/tensorflow/lite/micro/examples/person_detection/arc_emsdp
    install -m 644 ${S}/tensorflow/lite/micro/examples/person_detection/arduino/*.h ${D}${includedir}/tensorflow/lite/micro/examples/person_detection/arduino
    install -m 644 ${S}/tensorflow/lite/micro/examples/person_detection/arduino/*.inc ${D}${includedir}/tensorflow/lite/micro/examples/person_detection/arduino
    install -m 644 ${S}/tensorflow/lite/micro/examples/person_detection/esp/*.h ${D}${includedir}/tensorflow/lite/micro/examples/person_detection/esp
    install -m 644 ${S}/tensorflow/lite/micro/examples/person_detection/esp/*.inc ${D}${includedir}/tensorflow/lite/micro/examples/person_detection/esp
    install -m 644 ${S}/tensorflow/lite/micro/examples/person_detection/himax_driver/*.h ${D}${includedir}/tensorflow/lite/micro/examples/person_detection/himax_driver
    install -m 644 ${S}/tensorflow/lite/micro/examples/person_detection/himax_driver/*.inc ${D}${includedir}/tensorflow/lite/micro/examples/person_detection/himax_driver
    install -m 644 ${S}/tensorflow/lite/micro/examples/person_detection/riscv32_mcu/*.inc ${D}${includedir}/tensorflow/lite/micro/examples/person_detection/riscv32_mcu
    install -m 644 ${S}/tensorflow/lite/micro/examples/person_detection/spresense/*.inc ${D}${includedir}/tensorflow/lite/micro/examples/person_detection/spresense
    install -m 644 ${S}/tensorflow/lite/micro/kernels/*.h ${D}${includedir}/tensorflow/lite/micro/kernels
    install -m 644 ${S}/tensorflow/lite/micro/kernels/arc_mli/*.h ${D}${includedir}/tensorflow/lite/micro/kernels/arc_mli
    install -m 644 ${S}/tensorflow/lite/micro/kernels/ceva/*.h ${D}${includedir}/tensorflow/lite/micro/kernels/ceva
    install -m 644 ${S}/tensorflow/lite/micro/kernels/xtensa/*.h ${D}${includedir}/tensorflow/lite/micro/kernels/xtensa
    install -m 644 ${S}/tensorflow/lite/micro/memory_planner/*.h ${D}${includedir}/tensorflow/lite/micro/memory_planner
    install -m 644 ${S}/tensorflow/lite/micro/tools/make/*.inc ${D}${includedir}/tensorflow/lite/micro/tools/make
    install -m 644 ${S}/tensorflow/lite/micro/tools/make/ext_libs/*.inc ${D}${includedir}/tensorflow/lite/micro/tools/make/ext_libs
    install -m 644 ${S}/tensorflow/lite/micro/tools/make/targets/*.inc ${D}${includedir}/tensorflow/lite/micro/tools/make/targets
    install -m 644 ${S}/tensorflow/lite/micro/tools/make/targets/arc/*.inc ${D}${includedir}/tensorflow/lite/micro/tools/make/targets/arc
    install -m 644 ${S}/tensorflow/lite/micro/tools/make/templates/*.h ${D}${includedir}/tensorflow/lite/micro/tools/make/templates
    ...
    install -m 644 ${S}/tensorflow/lite/tools/make/targets/*.inc ${D}${includedir}/tensorflow/lite/tools/make/targets
    ...
    install -m 644 ${S}/tensorflow/lite/tools/optimize/sparsity/*.h ${D}${includedir}/tensorflow/lite/tools/optimize/sparsity
