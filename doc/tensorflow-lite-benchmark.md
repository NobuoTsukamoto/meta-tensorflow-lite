...
- [TFLite Model Benchmark Tool with C++ Binary - tensorflow/tensorflow](https://github.com/tensorflow/tensorflow/blob/v2.16.2/tensorflow/lite/tools/benchmark/README.md)
