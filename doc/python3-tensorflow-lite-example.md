...
- [TensorFlow Lite Python image classification demo - tensorflow/tensorflow](https://github.com/tensorflow/tensorflow/blob/v2.15.1/tensorflow/lite/examples/python/README.md)
