...
- [TensorFlow Lite C++ image classification demo - tensorflow/tensorflow](https://github.com/tensorflow/tensorflow/blob/v2.16.2/tensorflow/lite/examples/label_image/README.md)
