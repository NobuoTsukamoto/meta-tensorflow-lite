...
- [TensorFlow Lite C++ image classification demo - tensorflow/tensorflow](https://github.com/tensorflow/tensorflow/blob/v2.15.1/tensorflow/lite/examples/label_image/README.md)
...
See [libtensorflow-lite](../recipes-framework/tensorflow-lite/libtensorflow-lite_2.15.1.bb) for a recipe to build a shared library for libtensorflow-lite.so.
