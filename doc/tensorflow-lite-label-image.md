...
- [TensorFlow Lite C++ image classification demo - tensorflow/tensorflow](https://github.com/tensorflow/tensorflow/blob/v2.12.1/tensorflow/lite/examples/label_image/README.md)
...
- [001-v2.12_label_image_cpp.patch](../recipes-examples/tensorflow-lite/files/001-v2.12_label_image_cpp.patch)
