...
- [TensorFlow Lite C++ minimal example - tensorflow/tensorflow](https://github.com/tensorflow/tensorflow/blob/v2.21.0/tensorflow/lite/examples/minimal/README.md)
...
See [libtensorflow-lite](../recipes-framework/tensorflow-lite/libtensorflow-lite_2.21.0.bb) for a recipe to build a shared library for libtensorflow-lite.so.